...
@pytest.fixture
def alusd(safe):
    alusd = MintableForkToken(
        '0xBC6DA0FE9aD5f3b0d58160288917AA56653660E9', owner=safe.account
    )
    alusd._mint_for_testing(safe.address, 10_000 * 10**alusd.decimals())
    return alusd


@pytest.fixture
def aleth(safe):
    aleth = MintableForkToken(
        '0x0100546F2cD4C9D97f798fFC9755E47865FF7Ee6', owner=safe.account
    )
    aleth._mint_for_testing(safe.address, 10_000 * 10**aleth.decimals())
    return aleth
